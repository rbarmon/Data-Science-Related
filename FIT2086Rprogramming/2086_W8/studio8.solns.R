...
setwd("/Users/rianb/FIT2086Rprogramming/2086_W")
...
gene.test = read.csv("gene.test.csv", header=T, stringsAsFactors = T)
...
pima.train = read.csv("pima.test.csv", stringsAsFactors = T)
pima.test = read.csv("pima.train.csv", stringsAsFactors = T)
